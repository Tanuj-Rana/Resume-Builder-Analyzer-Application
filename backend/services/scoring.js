...
function calculateATSScore(resumeText, deterministicAnalysis = {}) {
    console.log("📊 Calculating ATS Score...");
    
    // Basic fallback scoring logic
    let score = 70; 
    if (resumeText && resumeText.length > 500) score += 10;
    if (deterministicAnalysis.missingKeywords?.length === 0) score += 10;
